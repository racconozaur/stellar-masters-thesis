...
SPEC_FN   = os.path.expanduser("trustlines/spectral_labels_all_k.csv")
...
out.to_csv("trustlines/trustlines_spectral_intrinsic_scores.csv", index=False)
...
out_csv = os.path.expanduser("trustlines/trustlines_spectral_external_vs_norm.csv")
